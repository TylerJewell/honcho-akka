...
A `LICENSE-honcho` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [plastic-labs/honcho](https://github.com/plastic-labs/honcho), Copyright
the plastic-labs/honcho authors, licensed under AGPL-3.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../honcho-port/specs/SPEC-001-honcho.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
